...
export const ex3_7: Solution = {
  ...
  content: `
Aquest és un problema clàssic que es pot modelar perfectament mitjançant la teoria de grafs i el concepte de **circuit eulerià**.
...
El graf que representa el dòmino és un $K_7$ amb bucles a cada node.
...
\`\`\`
:::
<div class="text-center text-xs text-slate-400 mt-2">Graf complet $K_7$. Tots els vèrtexs tenen grau 6 (parell). Les fitxes dobles funcionen com bucles i mantenen la paritat.</div>
  `,
