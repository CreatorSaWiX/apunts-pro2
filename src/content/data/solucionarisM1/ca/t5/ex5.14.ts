...
### 1) Intercanvi de files ($R_1 \\leftrightarrow R_2$)
...
### 3) Intercanvi de files ($R_1 \\leftrightarrow R_3$)
...
### 4) Combinació lineal de files ($R_3 \\to R_3 - 3R_2$)
