...
Volem demostrar la doble implicació: **$f$ bijectiu $\\iff 0$ no és valor propi**.

Recordem que un endomorfisme en un espai de dimensió finita és bijectiu si i només si és injectiu ($\\\\ker(f) = \\{\\vec{0}\\}$).
