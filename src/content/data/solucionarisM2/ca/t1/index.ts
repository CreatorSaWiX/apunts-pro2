...
Està certament **fitat inferiorment**, però no posseeix cota quan fuig a infinit per definició ascendent doncs no és superiorment en estar subjecte només a valors més grans que 1. $\\inf(C) = 1 \\text{ (no té suprem)}$.`
    ...
    {
        id: "M2-T1-Ex4",
        title: "Problema 4: Desigualtats creuades",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Trobeu tots els nombres reals $x$ que satisfan cadascuna de les desigualtats següents:
...
El conjunt $B$ és **fitat inferiorment** per $-1$, atès que no hi ha valors menors que $-1$, sent el seu **ínfim** $\\inf(B) = -1$. No està fitat superiorment.`
    ...
    {
        id: "M2-T1-Ex5",
        title: "Problema 5: Polinomis i valors absoluts amb condicions",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Trobeu els nombres reals $x$ tals que:

a) $x^3 - 1 \\geq 0$; $\\quad$ b) $(x-1)|x^2 - 2| > 0$; $\\quad$ c) $|4x - 5| \\leq 13$.

En cada apartat representeu sobre la recta real el conjunt de solucions i digueu si tal conjunt és fitat superiorment (inferiorment). En cas afirmatiu, trobeu-ne el suprem (ínfim).`,
        content: `**a)** $x^3 - 1 \\geq 0$
...
El conjunt $E$ és totalment **fitat**. Té mínim (ínfim) i màxim (suprem): $\\inf(E) = -2$ i $\\sup(E) = 9/2$.`
    ...
    {
        id: "M2-T1-Ex6",
        title: "Problema 6: Equacions i inequacions amb múltiples valors absoluts",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Trobeu els nombres reals $x$ tals que:
...
**Conjunt de solucions:** $D = (-5/2, -1/2)$. L'interval resultant és estrictament obert. Per tant, no té ni màxim ni mínim (té ínfim $-5/2$ i suprem $-1/2$).`
    ...
    {
        id: "M2-T1-Ex7",
        title: "Problema 7: Desigualtat triangular sobre polinomis de fraccions",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Proveu que si $|x| \\leq 1$, llavors es té:
$$ \\left| x^4 + \\frac{1}{2}x^3 + \\frac{1}{4}x^2 + \\frac{1}{8}x + \\frac{1}{16} \\right| < 2 $$`,
        content: `Per la **desigualtat triangular generalitzada**, definim que el valor absolut d'una suma sempre serà menor o, independentment, com a molt igual que la suma pròpia dels respectius valors absoluts individuals:
...
Queda demostrat.`
    ...
    {
        id: "M2-T1-Ex8",
        title: "Problema 8: Simplificació de valors absoluts en funcions definides a trossos",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Escriviu les expressions següents prescindint dels valors absoluts:
...
$$`
    ...
    {
        id: "M2-T1-Ex9",
        title: "Problema 9: Desigualtat Triangular Generalitzada amb sumatoris oposats",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Demostreu que per a tot $x \\in \\mathbb{R}$ es compleix $|x - 1| + |x - 2| \\geq 1$.
En quin cas aquesta desigualtat és una igualtat?`,
        content: `Per la desigualtat triangular $|a| + |b| \\geq |a + b|$ i sabent que $|x - 2| = |2 - x|$:
...
$$ (x-1)(2-x) \\geq 0 \\implies x \\in [1, 2] $$`
    ...
    {
        id: "M2-T1-Ex10",
        title: "Problema 10: Inequacions compostes de paràmetres de polinomis i extrems absoluts",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Trobeu els nombres reals $x$ tals que:
...
$B = \\left[ \\frac{5-\\sqrt{13}}{2}, \\frac{5-\\sqrt{2}}{2} \\right] \\cup \\{ \\frac{5}{2} \\} \\cup \\left[ \\frac{5+\\sqrt{2}}{2}, \\frac{5+\\sqrt{13}}{2} \\right]$. $\\quad$ Mínim: $\\frac{5-\\sqrt{13}}{2}$, Màxim: $\\frac{5+\\sqrt{13}}{2}$.`
    ...
    {
        id: "M2-T1-Ex11",
        title: "Problema 11: Inequacions diverses de grau superior i quocients creuats",
        author: "Apunts",
        type: "notebook",
        code: "",
        statement: `Resoleu les inequacions següents:
...
d) $|2 - x^2| < 1$; $\\quad$ e) $x^2 < |2x + 8|$; $\\quad$ f) $|x^2 - 5x| > |x^2| - |5x|$.`,
        content: `**a)** $| \\frac{2x-2}{x+4} | < 1 \\implies \\frac{2x-2}{x+4} \\in (-1, 1) \\implies x \\in (-2/3, 6)$.
