...
*   $\\frac{\\partial f}{\\partial x} = 3ax^2 + 3by^2 - 15a^2$
*   $\\frac{\\partial f}{\\partial y} = 6bxy - 12$

Substituïm el punt $(2,1)$:
1.  $\\frac{\\partial f}{\\partial y}(2,1) = 12b - 12 = 0 \\implies \\mathbf{b = 1}$
2.  $\\frac{\\partial f}{\\partial x}(2,1) = 12a + 3b - 15a^2 = 0$
...
*   $\\frac{\\partial^2 f}{\\partial x^2} = 6ax \\implies \\frac{\\partial^2 f}{\\partial x^2}(2,1) = 12a$
*   $\\frac{\\partial^2 f}{\\partial y^2} = 6bx \\implies \\frac{\\partial^2 f}{\\partial y^2}(2,1) = 12b = 12$ (ja que $b=1$)
*   $\\frac{\\partial^2 f}{\\partial x \\partial y} = 6by \\implies \\frac{\\partial^2 f}{\\partial x \\partial y}(2,1) = 6b = 6$
