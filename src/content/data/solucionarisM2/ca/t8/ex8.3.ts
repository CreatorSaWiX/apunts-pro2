...
export const ex8_3: Solution = {
  ...
  content: `Com que $z = f(x,y) = x^2 - y^2$ és un polinomi, sabem que $f \\in C^\\infty(\\mathbb{R}^2)$ (i per tant $C^1$). Per tant, és diferenciable al punt $M(1,1)$ i podem usar la fórmula del gradient.
...
Calculem les derivades parcials al punt $M(1,1)$:
