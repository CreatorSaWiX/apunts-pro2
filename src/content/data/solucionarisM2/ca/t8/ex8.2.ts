...
export const ex8_2: Solution = {
  ...
  content: `Com que $f(x,y) = x^2 + y^2$ és una funció polinòmica, és de classe $C^\\infty$ (i per tant $C^1$) a tot $\\mathbb{R}^2$. Això ens garanteix que la funció és diferenciable al punt $P(2,3)$ i podem calcular la derivada direccional mitjançant el gradient.
