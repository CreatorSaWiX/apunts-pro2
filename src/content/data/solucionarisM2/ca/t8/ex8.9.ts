...
Primer comprovem que $f$ és de classe $C^\\infty$ (és polinòmica).
* $\\frac{\\partial f}{\\partial x} = 2x \\implies \\frac{\\partial f}{\\partial x}(-1,3) = -2$
* $\\frac{\\partial f}{\\partial y} = 2(y-1) \\implies \\frac{\\partial f}{\\partial y}(-1,3) = 4$
$$\\nabla f(-1,3) = (-2, 4)$$
