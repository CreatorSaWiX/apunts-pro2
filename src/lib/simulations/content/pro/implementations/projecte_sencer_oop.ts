...
export const projecte_sencer_oop: Simulation = {
    ...
    generateSteps: (): SimulationStep[] => {
        const builder = new OOPBuilder()
            ...
            .addStep(6, "pro.projecte_sencer_oop.step_5")
            .setActiveFile("main.cc")
            .setVariables({ "Punt::comptador": "0", "p1": "Punt {x: -858993460, y: -858993460}" })
            ...
            .addStep(6, "pro.projecte_sencer_oop.step_7")
            .setActiveFile("Punt.cpp")
            ...
            .addStep(18, "pro.projecte_sencer_oop.step_17")
            .setActiveFile("main.cc")
            .setVariables({ "Punt::comptador": "2" })
