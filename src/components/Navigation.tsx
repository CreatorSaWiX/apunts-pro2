...
const Navigation: React.FC = () => {
    ...
    useEffect(() => {
        const handleCanvasChange = (e: CustomEvent | Event) => {
            if ('detail' in e) {
                setIsCanvasActive(!!(e as CustomEvent).detail);
            }
        };
        window.addEventListener('apunts_canvas_active', handleCanvasChange as EventListener);
        return () => window.removeEventListener('apunts_canvas_active', handleCanvasChange as EventListener);
    }, []);
