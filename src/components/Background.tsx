...
const Background: React.FC = () => {
    return (
        <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none z-0 bg-[#020617]">
            {/* Base Radial Gradient - Slightly lighter center */}
            ...
            {/* Vibrant Orbs - Intensified */}
            {/* Orb 1: Primary Blue/Cyan - Top Left */}
            <div
            ...
            {/* Orb 3: Pink/Rose Accent - Mid Left */}
            <div
