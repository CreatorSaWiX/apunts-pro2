                        ...
                        <div className="bg-[#13131A]/40 backdrop-blur-xl rounded-2xl p-3 border border-white/10 w-[350px] shadow-2xl flex flex-col gap-2">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <button
                                    ...
                                    aria-label="Tancar"><X size={16} strokeWidth={2.5} /></button>
                            </div>
                            ...
                            <div className="flex gap-3 items-center justify-center py-2 bg-white/[0.02] rounded-xl border border-white/[0.02]">
                                {PRESET_COLORS.map(color => (
                                    <button
                                        ...
                                        className={`w-4 h-4 rounded-full transition duration-300 bg-${color} ${newColumnColor === color ? `scale-125 shadow-[0_0_12px_currentColor] text-${color} ring-2 ring-${color} ring-offset-2 ring-offset-[#13131A]` : 'opacity-50 hover:opacity-100 hover:scale-110'}`}
                                        aria-label="Botó" />
                                ))}
                            </div>
                            <input
                            ...
                            />
                            <button type="button" onClick={handleAddColumn} className="mt-1 bg-white/5 hover:bg-white/10 text-white text-[12px] font-semibold tracking-wide py-2.5 rounded-xl transition-colors border border-white/5 hover:border-white/10 w-full shadow-sm" aria-label="Botó interactiu">{t('planner.boardView.createList', 'CREAR LLISTA')}</button>
                        </div>
                    )}
                </div>
