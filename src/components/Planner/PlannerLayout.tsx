    ...
    return (
        <div className="flex flex-col flex-1 h-full relative w-full">
            ...
            <div className="fixed top-5 md:top-6 right-4 sm:right-6 z-50">
                <div className="bg-slate-900/80 backdrop-blur-[40px] p-1.5 rounded-full border border-white/[0.12] flex shrink-0 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_10px_40px_rgba(0,0,0,0.5)] relative overflow-hidden transition-all hover:bg-slate-900/90 hover:border-white/20">
                    {[
            ...
            {/* Magic AI Button (Fixed Top Center) */}
            <div className="fixed top-5 md:top-6 left-1/2 -translate-x-1/2 z-50">
                <button
                    onClick={() => setIsAIModalOpen(true)}
                    className="group relative flex items-center gap-2 px-5 sm:px-6 py-2 sm:py-2.5 rounded-full transition-all duration-500 text-[11px] sm:text-sm font-extrabold tracking-wide shrink-0 hover:scale-[1.02] active:scale-[0.98] overflow-hidden shadow-[0_0_20px_rgba(168,85,247,0.15)] hover:shadow-[0_0_40px_rgba(168,85,247,0.3)]"
                >
